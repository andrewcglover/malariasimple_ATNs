...
// [[dust2::class(malariasimple_atn_deterministic)]]
...
class malariasimple_atn_deterministic {
public:
  malariasimple_atn_deterministic() = delete;
  ...
  static void update(real_type time, real_type dt, const real_type* state, const shared_state& shared, internal_state& internal, rng_state_type& rng_state, real_type* state_next) {
    ...
    internal.dSv[1] = dt * (delta_atn * (av - Lambda0_t) * Svtot - (av * delta_atn + (1 - delta_atn) * internal.Lambda_i[1] + shared.kappa + mu) * Sv[1]);
    ...
    internal.dEv[1] = dt * (av * delta_atn * internal.Ecol[0] + delta_atn * Lambda0_t * Svtot + (1 - delta_atn) * internal.Lambda_i[1] * Sv[1] - (av * delta_atn + shared.kappa + internal.rho_i[1] + mu) * Ev[1]);
    for (size_t i = 3; i <= static_cast<size_t>(shared.deltaqp1); ++i) {
    ...
    internal.dIv[1] = dt * (av * delta_atn * Itot + internal.rho_i[1] * Ev[1 + (shared.spor_len - 1) * shared.dim.Ev.mult[1]] - (av * delta_atn + shared.kappa + mu) * Iv[1]);
    for (size_t i = 3; i <= static_cast<size_t>(shared.deltaqp1); ++i) {
...
SEXP dust2_system_malariasimple_atn_deterministic_alloc(cpp11::list r_pars, cpp11::sexp r_time, cpp11::list r_time_control, cpp11::sexp r_n_particles, cpp11::sexp r_n_groups, cpp11::sexp r_seed, cpp11::sexp r_deterministic, cpp11::sexp r_n_threads) {
  return dust2::r::dust2_discrete_alloc<malariasimple_atn_deterministic>(r_pars, r_time, r_time_control, r_n_particles, r_n_groups, r_seed, r_deterministic, r_n_threads);
}
[[cpp11::register]]
SEXP dust2_system_malariasimple_atn_deterministic_run_to_time(cpp11::sexp ptr, cpp11::sexp r_time) {
  return dust2::r::dust2_system_run_to_time<dust2::dust_discrete<malariasimple_atn_deterministic>>(ptr, r_time);
}
...
SEXP dust2_system_malariasimple_atn_deterministic_state(cpp11::sexp ptr, cpp11::sexp r_index_state, cpp11::sexp r_index_particle, cpp11::sexp r_index_group, bool preserve_particle_dimension, bool preserve_group_dimension) {
  return dust2::r::dust2_system_state<dust2::dust_discrete<malariasimple_atn_deterministic>>(ptr, r_index_state, r_index_particle, r_index_group, preserve_particle_dimension, preserve_group_dimension);
}

[[cpp11::register]]
SEXP dust2_system_malariasimple_atn_deterministic_time(cpp11::sexp ptr) {
  return dust2::r::dust2_system_time<dust2::dust_discrete<malariasimple_atn_deterministic>>(ptr);
}

[[cpp11::register]]
SEXP dust2_system_malariasimple_atn_deterministic_set_state_initial(cpp11::sexp ptr) {
  return dust2::r::dust2_system_set_state_initial<dust2::dust_discrete<malariasimple_atn_deterministic>>(ptr);
}

[[cpp11::register]]
SEXP dust2_system_malariasimple_atn_deterministic_set_state(cpp11::sexp ptr, cpp11::list r_state) {
  return dust2::r::dust2_system_set_state<dust2::dust_discrete<malariasimple_atn_deterministic>>(ptr, r_state);
}

[[cpp11::register]]
SEXP dust2_system_malariasimple_atn_deterministic_reorder(cpp11::sexp ptr, cpp11::integers r_index) {
  return dust2::r::dust2_system_reorder<dust2::dust_discrete<malariasimple_atn_deterministic>>(ptr, r_index);
}

[[cpp11::register]]
SEXP dust2_system_malariasimple_atn_deterministic_rng_state(cpp11::sexp ptr) {
  return dust2::r::dust2_system_rng_state<dust2::dust_discrete<malariasimple_atn_deterministic>>(ptr);
}

[[cpp11::register]]
SEXP dust2_system_malariasimple_atn_deterministic_set_rng_state(cpp11::sexp ptr, cpp11::sexp r_rng_state) {
  return dust2::r::dust2_system_set_rng_state<dust2::dust_discrete<malariasimple_atn_deterministic>>(ptr, r_rng_state);
}

[[cpp11::register]]
SEXP dust2_system_malariasimple_atn_deterministic_set_time(cpp11::sexp ptr, cpp11::sexp r_time) {
  return dust2::r::dust2_system_set_time<dust2::dust_discrete<malariasimple_atn_deterministic>>(ptr, r_time);
}

[[cpp11::register]]
SEXP dust2_system_malariasimple_atn_deterministic_update_pars(cpp11::sexp ptr, cpp11::list pars) {
  return dust2::r::dust2_system_update_pars<dust2::dust_discrete<malariasimple_atn_deterministic>>(ptr, pars);
}
...
SEXP dust2_system_malariasimple_atn_deterministic_simulate(cpp11::sexp ptr, cpp11::sexp r_times, cpp11::sexp r_index_state, bool preserve_particle_dimension, bool preserve_group_dimension) {
  return dust2::r::dust2_system_simulate<dust2::dust_discrete<malariasimple_atn_deterministic>>(ptr, r_times, r_index_state, preserve_particle_dimension, preserve_group_dimension);
}
...
SEXP dust2_unfilter_malariasimple_atn_deterministic_alloc(cpp11::list r_pars, cpp11::sexp r_time_start, cpp11::sexp r_time, cpp11::list r_time_control, cpp11::list r_data, cpp11::sexp r_n_particles, cpp11::sexp r_n_groups, cpp11::sexp r_n_threads) {
  return dust2::r::dust2_discrete_unfilter_alloc<malariasimple_atn_deterministic>(r_pars, r_time_start, r_time, r_time_control, r_data, r_n_particles, r_n_groups, r_n_threads);
}
...
SEXP dust2_filter_malariasimple_atn_deterministic_alloc(cpp11::list r_pars, cpp11::sexp r_time_start, cpp11::sexp r_time, cpp11::list r_time_control, cpp11::list r_data, cpp11::sexp r_n_particles, cpp11::sexp r_n_groups, cpp11::sexp r_n_threads, cpp11::sexp r_seed) {
  return dust2::r::dust2_discrete_filter_alloc<malariasimple_atn_deterministic>(r_pars, r_time_start, r_time, r_time_control, r_data, r_n_particles, r_n_groups, r_n_threads, r_seed);
}
[[cpp11::register]]
SEXP dust2_system_malariasimple_atn_deterministic_compare_data(cpp11::sexp ptr, cpp11::list r_data, bool preserve_particle_dimension, bool preserve_group_dimension) {
  return dust2::r::dust2_system_compare_data<dust2::dust_discrete<malariasimple_atn_deterministic>>(ptr, r_data, preserve_particle_dimension, preserve_group_dimension);
}
...
SEXP dust2_unfilter_malariasimple_atn_deterministic_update_pars(cpp11::sexp ptr, cpp11::list r_pars, cpp11::sexp r_index_group) {
  return dust2::r::dust2_unfilter_update_pars<dust2::dust_discrete<malariasimple_atn_deterministic>>(ptr, r_pars, r_index_group);
}
...
SEXP dust2_unfilter_malariasimple_atn_deterministic_run(cpp11::sexp ptr, cpp11::sexp r_initial, bool save_trajectories, cpp11::sexp save_snapshots, bool adjoint, cpp11::sexp r_index_state, cpp11::sexp r_index_group, bool preserve_particle_dimension, bool preserve_group_dimension) {
  return dust2::r::dust2_unfilter_run<dust2::dust_discrete<malariasimple_atn_deterministic>>(ptr, r_initial, save_trajectories, save_snapshots, adjoint, r_index_state, r_index_group, preserve_particle_dimension, preserve_group_dimension);
}
...
SEXP dust2_unfilter_malariasimple_atn_deterministic_last_trajectories(cpp11::sexp ptr, bool select_random_particle, bool preserve_particle_dimension, bool preserve_group_dimension) {
  return dust2::r::dust2_unfilter_last_trajectories<dust2::dust_discrete<malariasimple_atn_deterministic>>(ptr, select_random_particle, preserve_particle_dimension, preserve_group_dimension);
}
...
SEXP dust2_unfilter_malariasimple_atn_deterministic_last_snapshots(cpp11::sexp ptr, bool select_random_particle, bool preserve_particle_dimension, bool preserve_group_dimension) {
  return dust2::r::dust2_unfilter_last_snapshots<dust2::dust_discrete<malariasimple_atn_deterministic>>(ptr, select_random_particle, preserve_particle_dimension, preserve_group_dimension);
}
...
SEXP dust2_unfilter_malariasimple_atn_deterministic_last_state(cpp11::sexp ptr, bool select_random_particle, bool preserve_particle_dimension, bool preserve_group_dimension) {
  return dust2::r::dust2_unfilter_last_state<dust2::dust_discrete<malariasimple_atn_deterministic>>(ptr, select_random_particle, preserve_particle_dimension, preserve_group_dimension);
}

[[cpp11::register]]
SEXP dust2_filter_malariasimple_atn_deterministic_update_pars(cpp11::sexp ptr, cpp11::list r_pars, cpp11::sexp r_index_group) {
  return dust2::r::dust2_filter_update_pars<dust2::dust_discrete<malariasimple_atn_deterministic>>(ptr, r_pars, r_index_group);
}
...
SEXP dust2_filter_malariasimple_atn_deterministic_run(cpp11::sexp ptr, cpp11::sexp r_initial, bool save_trajectories, cpp11::sexp save_snapshots, bool adjoint, cpp11::sexp index_state, cpp11::sexp index_group, bool preserve_particle_dimension, bool preserve_group_dimension) {
  return dust2::r::dust2_filter_run<dust2::dust_discrete<malariasimple_atn_deterministic>>(ptr, r_initial, save_trajectories, save_snapshots, adjoint, index_state, index_group, preserve_particle_dimension, preserve_group_dimension);
}
...
SEXP dust2_filter_malariasimple_atn_deterministic_last_trajectories(cpp11::sexp ptr, bool select_random_particle, bool preserve_particle_dimension, bool preserve_group_dimension) {
  return dust2::r::dust2_filter_last_trajectories<dust2::dust_discrete<malariasimple_atn_deterministic>>(ptr, select_random_particle, preserve_particle_dimension, preserve_group_dimension);
}
...
SEXP dust2_filter_malariasimple_atn_deterministic_last_snapshots(cpp11::sexp ptr, bool select_random_particle, bool preserve_particle_dimension, bool preserve_group_dimension) {
  return dust2::r::dust2_filter_last_snapshots<dust2::dust_discrete<malariasimple_atn_deterministic>>(ptr, select_random_particle, preserve_particle_dimension, preserve_group_dimension);
}
...
SEXP dust2_filter_malariasimple_atn_deterministic_last_state(cpp11::sexp ptr, bool select_random_particle, bool preserve_particle_dimension, bool preserve_group_dimension) {
  return dust2::r::dust2_filter_last_state<dust2::dust_discrete<malariasimple_atn_deterministic>>(ptr, select_random_particle, preserve_particle_dimension, preserve_group_dimension);
}

[[cpp11::register]]
SEXP dust2_filter_malariasimple_atn_deterministic_rng_state(cpp11::sexp ptr) {
  return dust2::r::dust2_filter_rng_state<dust2::dust_discrete<malariasimple_atn_deterministic>>(ptr);
}

[[cpp11::register]]
SEXP dust2_filter_malariasimple_atn_deterministic_set_rng_state(cpp11::sexp ptr, cpp11::sexp r_rng_state) {
  return dust2::r::dust2_filter_set_rng_state<dust2::dust_discrete<malariasimple_atn_deterministic>>(ptr, r_rng_state);
}
