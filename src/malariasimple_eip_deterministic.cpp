...
// [[dust2::class(malariasimple_eip_deterministic)]]
...
class malariasimple_eip_deterministic {
public:
  malariasimple_eip_deterministic() = delete;
  ...
  static void initial(real_type time, const shared_state& shared, internal_state& internal, rng_state_type& rng_state, real_type* state) {
    ...
    for (size_t i = 1; i <= static_cast<size_t>(shared.spor_len); ++i) {
      state[i - 1 + shared.odin.offset.state[32]] = E1_eq * monty::math::pow(Ev_ratio, (i - 1));
    }
    ...
    for (size_t i = 1; i <= shared.dim.detect_prev_full.dim[0]; ++i) {
      for (size_t j = 1; j <= shared.dim.detect_prev_full.dim[1]; ++j) {
        for (size_t k = 1; k <= shared.dim.detect_prev_full.dim[2]; ++k) {
          state[i - 1 + (j - 1) * shared.dim.detect_prev_full.mult[1] + (k - 1) * shared.dim.detect_prev_full.mult[2] + shared.odin.offset.state[35]] = shared.init_D[i - 1 + (j - 1) * shared.dim.init_D.mult[1] + (k - 1) * shared.dim.init_D.mult[2]];
        }
      }
    }
    ...
    for (size_t i = 1; i <= shared.dim.n_ud_inc.size; ++i) {
      state[i - 1 + shared.odin.offset.state[38]] = shared.min_age_inc[i - 1];
    }
    state[7] = 0;
    state[8] = 0;
    state[9] = 0;
    ...
    for (size_t i = 1; i <= shared.dim.detect.dim[0]; ++i) {
      for (size_t j = 1; j <= shared.dim.detect.dim[1]; ++j) {
        for (size_t k = 1; k <= shared.dim.detect.dim[2]; ++k) {
          state[i - 1 + (j - 1) * shared.dim.detect.mult[1] + (k - 1) * shared.dim.detect.mult[2] + shared.odin.offset.state[39]] = shared.init_D[i - 1 + (j - 1) * shared.dim.init_D.mult[1] + (k - 1) * shared.dim.init_D.mult[2]] + shared.init_T[i - 1 + (j - 1) * shared.dim.init_T.mult[1] + (k - 1) * shared.dim.init_T.mult[2]];
        }
      }
    }
    for (size_t i = 1; i <= shared.dim.n.dim[0]; ++i) {
      for (size_t j = 1; j <= shared.dim.n.dim[1]; ++j) {
        for (size_t k = 1; k <= shared.dim.n.dim[2]; ++k) {
          state[i - 1 + (j - 1) * shared.dim.n.mult[1] + (k - 1) * shared.dim.n.mult[2] + shared.odin.offset.state[40]] = shared.init_A[i - 1 + (j - 1) * shared.dim.init_A.mult[1] + (k - 1) * shared.dim.init_A.mult[2]] + shared.init_T[i - 1 + (j - 1) * shared.dim.init_T.mult[1] + (k - 1) * shared.dim.init_T.mult[2]] + shared.init_D[i - 1 + (j - 1) * shared.dim.init_D.mult[1] + (k - 1) * shared.dim.init_D.mult[2]] + shared.init_P[i - 1 + (j - 1) * shared.dim.init_P.mult[1] + (k - 1) * shared.dim.init_P.mult[2]] + shared.init_U[i - 1 + (j - 1) * shared.dim.init_U.mult[1] + (k - 1) * shared.dim.init_U.mult[2]] + shared.init_S[i - 1 + (j - 1) * shared.dim.init_S.mult[1] + (k - 1) * shared.dim.init_S.mult[2]];
        }
      }
    }
  }
  static void update(real_type time, real_type dt, const real_type* state, const shared_state& shared, internal_state& internal, rng_state_type& rng_state, real_type* state_next) {
    ...
    const auto * detect_prev_full = state + shared.odin.offset.state[35];
    ...
    state_next[shared.odin.offset.state[32]] = (Ev[0] + dt * (ince - shared.kappa * Ev[0] - mu * Ev[0]) < 0 ? 0 : Ev[0] + dt * (ince - shared.kappa * Ev[0] - mu * Ev[0]));
    for (size_t i = 2; i <= static_cast<size_t>(shared.spor_len); ++i) {
      state_next[i - 1 + shared.odin.offset.state[32]] = (Ev[i - 1] + dt * (shared.kappa * Ev[i - 1 - 1] - shared.kappa * Ev[i - 1] - mu * Ev[i - 1]) < 0 ? 0 : Ev[i - 1] + dt * (shared.kappa * Ev[i - 1 - 1] - shared.kappa * Ev[i - 1] - mu * Ev[i - 1]));
    }
    ...
    for (size_t i = 1; i <= shared.dim.detect_prev_full.dim[0]; ++i) {
      for (size_t j = 1; j <= shared.dim.detect_prev_full.dim[1]; ++j) {
        for (size_t k = 1; k <= shared.dim.detect_prev_full.dim[2]; ++k) {
          state_next[i - 1 + (j - 1) * shared.dim.detect_prev_full.mult[1] + (k - 1) * shared.dim.detect_prev_full.mult[2] + shared.odin.offset.state[35]] = T[i - 1 + (j - 1) * shared.dim.T.mult[1] + (k - 1) * shared.dim.T.mult[2]] + D[i - 1 + (j - 1) * shared.dim.D.mult[1] + (k - 1) * shared.dim.D.mult[2]] + A[i - 1 + (j - 1) * shared.dim.A.mult[1] + (k - 1) * shared.dim.A.mult[2]] * internal.p_det[i - 1 + (j - 1) * shared.dim.p_det.mult[1] + (k - 1) * shared.dim.p_det.mult[2]];
        }
      }
    }
    for (size_t i = 1; i <= shared.dim.n_ud_prev.size; ++i) {
      state_next[i - 1 + shared.odin.offset.state[36]] = internal.n_prev[i - 1];
    }
    for (size_t i = 1; i <= shared.dim.n_ud_detect_prev.size; ++i) {
      state_next[i - 1 + shared.odin.offset.state[37]] = internal.detect_prev[i - 1];
    }
    for (size_t i = 1; i <= shared.dim.n_ud_inc.size; ++i) {
      state_next[i - 1 + shared.odin.offset.state[38]] = dust2::array::sum<real_type>(clin_inc, shared.dim.clin_inc, {shared.min_age_inc[i - 1] - 1, shared.max_age_inc[i - 1] - 1}, {0, shared.dim.clin_inc.dim[1] - 1}, {0, shared.dim.clin_inc.dim[2] - 1}) / dt;
    }
    state_next[7] = Sh;
    state_next[8] = Th;
    state_next[9] = Dh;
    ...
    for (size_t i = 1; i <= shared.dim.detect.dim[0]; ++i) {
      for (size_t j = 1; j <= shared.dim.detect.dim[1]; ++j) {
        for (size_t k = 1; k <= shared.dim.detect.dim[2]; ++k) {
          state_next[i - 1 + (j - 1) * shared.dim.detect.mult[1] + (k - 1) * shared.dim.detect.mult[2] + shared.odin.offset.state[39]] = T[i - 1 + (j - 1) * shared.dim.T.mult[1] + (k - 1) * shared.dim.T.mult[2]] + D[i - 1 + (j - 1) * shared.dim.D.mult[1] + (k - 1) * shared.dim.D.mult[2]] + A[i - 1 + (j - 1) * shared.dim.A.mult[1] + (k - 1) * shared.dim.A.mult[2]] * internal.p_det[i - 1 + (j - 1) * shared.dim.p_det.mult[1] + (k - 1) * shared.dim.p_det.mult[2]];
        }
      }
    }
    for (size_t i = 1; i <= shared.dim.n.dim[0]; ++i) {
      for (size_t j = 1; j <= shared.dim.n.dim[1]; ++j) {
        for (size_t k = 1; k <= shared.dim.n.dim[2]; ++k) {
          state_next[i - 1 + (j - 1) * shared.dim.n.mult[1] + (k - 1) * shared.dim.n.mult[2] + shared.odin.offset.state[40]] = internal.all[i - 1 + (j - 1) * shared.dim.all.mult[1] + (k - 1) * shared.dim.all.mult[2]];
        }
      }
    }
  }
  static real_type compare_data(real_type time, const real_type* state, const data_type& data, const shared_state& shared, internal_state& internal, rng_state_type& rng_state) {
    ...
    const auto * n_ud_prev = state + shared.odin.offset.state[36];
    const auto * n_ud_detect_prev = state + shared.odin.offset.state[37];
    real_type odin_ll = 0;
...
SEXP dust2_system_malariasimple_eip_deterministic_alloc(cpp11::list r_pars, cpp11::sexp r_time, cpp11::list r_time_control, cpp11::sexp r_n_particles, cpp11::sexp r_n_groups, cpp11::sexp r_seed, cpp11::sexp r_deterministic, cpp11::sexp r_n_threads) {
  return dust2::r::dust2_discrete_alloc<malariasimple_eip_deterministic>(r_pars, r_time, r_time_control, r_n_particles, r_n_groups, r_seed, r_deterministic, r_n_threads);
}
[[cpp11::register]]
SEXP dust2_system_malariasimple_eip_deterministic_run_to_time(cpp11::sexp ptr, cpp11::sexp r_time) {
  return dust2::r::dust2_system_run_to_time<dust2::dust_discrete<malariasimple_eip_deterministic>>(ptr, r_time);
}
...
SEXP dust2_system_malariasimple_eip_deterministic_state(cpp11::sexp ptr, cpp11::sexp r_index_state, cpp11::sexp r_index_particle, cpp11::sexp r_index_group, bool preserve_particle_dimension, bool preserve_group_dimension) {
  return dust2::r::dust2_system_state<dust2::dust_discrete<malariasimple_eip_deterministic>>(ptr, r_index_state, r_index_particle, r_index_group, preserve_particle_dimension, preserve_group_dimension);
}

[[cpp11::register]]
SEXP dust2_system_malariasimple_eip_deterministic_time(cpp11::sexp ptr) {
  return dust2::r::dust2_system_time<dust2::dust_discrete<malariasimple_eip_deterministic>>(ptr);
}

[[cpp11::register]]
SEXP dust2_system_malariasimple_eip_deterministic_set_state_initial(cpp11::sexp ptr) {
  return dust2::r::dust2_system_set_state_initial<dust2::dust_discrete<malariasimple_eip_deterministic>>(ptr);
}

[[cpp11::register]]
SEXP dust2_system_malariasimple_eip_deterministic_set_state(cpp11::sexp ptr, cpp11::list r_state) {
  return dust2::r::dust2_system_set_state<dust2::dust_discrete<malariasimple_eip_deterministic>>(ptr, r_state);
}

[[cpp11::register]]
SEXP dust2_system_malariasimple_eip_deterministic_reorder(cpp11::sexp ptr, cpp11::integers r_index) {
  return dust2::r::dust2_system_reorder<dust2::dust_discrete<malariasimple_eip_deterministic>>(ptr, r_index);
}

[[cpp11::register]]
SEXP dust2_system_malariasimple_eip_deterministic_rng_state(cpp11::sexp ptr) {
  return dust2::r::dust2_system_rng_state<dust2::dust_discrete<malariasimple_eip_deterministic>>(ptr);
}

[[cpp11::register]]
SEXP dust2_system_malariasimple_eip_deterministic_set_rng_state(cpp11::sexp ptr, cpp11::sexp r_rng_state) {
  return dust2::r::dust2_system_set_rng_state<dust2::dust_discrete<malariasimple_eip_deterministic>>(ptr, r_rng_state);
}

[[cpp11::register]]
SEXP dust2_system_malariasimple_eip_deterministic_set_time(cpp11::sexp ptr, cpp11::sexp r_time) {
  return dust2::r::dust2_system_set_time<dust2::dust_discrete<malariasimple_eip_deterministic>>(ptr, r_time);
}

[[cpp11::register]]
SEXP dust2_system_malariasimple_eip_deterministic_update_pars(cpp11::sexp ptr, cpp11::list pars) {
  return dust2::r::dust2_system_update_pars<dust2::dust_discrete<malariasimple_eip_deterministic>>(ptr, pars);
}
...
SEXP dust2_system_malariasimple_eip_deterministic_simulate(cpp11::sexp ptr, cpp11::sexp r_times, cpp11::sexp r_index_state, bool preserve_particle_dimension, bool preserve_group_dimension) {
  return dust2::r::dust2_system_simulate<dust2::dust_discrete<malariasimple_eip_deterministic>>(ptr, r_times, r_index_state, preserve_particle_dimension, preserve_group_dimension);
}
...
SEXP dust2_unfilter_malariasimple_eip_deterministic_alloc(cpp11::list r_pars, cpp11::sexp r_time_start, cpp11::sexp r_time, cpp11::list r_time_control, cpp11::list r_data, cpp11::sexp r_n_particles, cpp11::sexp r_n_groups, cpp11::sexp r_n_threads) {
  return dust2::r::dust2_discrete_unfilter_alloc<malariasimple_eip_deterministic>(r_pars, r_time_start, r_time, r_time_control, r_data, r_n_particles, r_n_groups, r_n_threads);
}
...
SEXP dust2_filter_malariasimple_eip_deterministic_alloc(cpp11::list r_pars, cpp11::sexp r_time_start, cpp11::sexp r_time, cpp11::list r_time_control, cpp11::list r_data, cpp11::sexp r_n_particles, cpp11::sexp r_n_groups, cpp11::sexp r_n_threads, cpp11::sexp r_seed) {
  return dust2::r::dust2_discrete_filter_alloc<malariasimple_eip_deterministic>(r_pars, r_time_start, r_time, r_time_control, r_data, r_n_particles, r_n_groups, r_n_threads, r_seed);
}
[[cpp11::register]]
SEXP dust2_system_malariasimple_eip_deterministic_compare_data(cpp11::sexp ptr, cpp11::list r_data, bool preserve_particle_dimension, bool preserve_group_dimension) {
  return dust2::r::dust2_system_compare_data<dust2::dust_discrete<malariasimple_eip_deterministic>>(ptr, r_data, preserve_particle_dimension, preserve_group_dimension);
}
...
SEXP dust2_unfilter_malariasimple_eip_deterministic_update_pars(cpp11::sexp ptr, cpp11::list r_pars, cpp11::sexp r_index_group) {
  return dust2::r::dust2_unfilter_update_pars<dust2::dust_discrete<malariasimple_eip_deterministic>>(ptr, r_pars, r_index_group);
}
...
SEXP dust2_unfilter_malariasimple_eip_deterministic_run(cpp11::sexp ptr, cpp11::sexp r_initial, bool save_trajectories, cpp11::sexp save_snapshots, bool adjoint, cpp11::sexp r_index_state, cpp11::sexp r_index_group, bool preserve_particle_dimension, bool preserve_group_dimension) {
  return dust2::r::dust2_unfilter_run<dust2::dust_discrete<malariasimple_eip_deterministic>>(ptr, r_initial, save_trajectories, save_snapshots, adjoint, r_index_state, r_index_group, preserve_particle_dimension, preserve_group_dimension);
}
...
SEXP dust2_unfilter_malariasimple_eip_deterministic_last_trajectories(cpp11::sexp ptr, bool select_random_particle, bool preserve_particle_dimension, bool preserve_group_dimension) {
  return dust2::r::dust2_unfilter_last_trajectories<dust2::dust_discrete<malariasimple_eip_deterministic>>(ptr, select_random_particle, preserve_particle_dimension, preserve_group_dimension);
}
...
SEXP dust2_unfilter_malariasimple_eip_deterministic_last_snapshots(cpp11::sexp ptr, bool select_random_particle, bool preserve_particle_dimension, bool preserve_group_dimension) {
  return dust2::r::dust2_unfilter_last_snapshots<dust2::dust_discrete<malariasimple_eip_deterministic>>(ptr, select_random_particle, preserve_particle_dimension, preserve_group_dimension);
}
...
SEXP dust2_unfilter_malariasimple_eip_deterministic_last_state(cpp11::sexp ptr, bool select_random_particle, bool preserve_particle_dimension, bool preserve_group_dimension) {
  return dust2::r::dust2_unfilter_last_state<dust2::dust_discrete<malariasimple_eip_deterministic>>(ptr, select_random_particle, preserve_particle_dimension, preserve_group_dimension);
}

[[cpp11::register]]
SEXP dust2_filter_malariasimple_eip_deterministic_update_pars(cpp11::sexp ptr, cpp11::list r_pars, cpp11::sexp r_index_group) {
  return dust2::r::dust2_filter_update_pars<dust2::dust_discrete<malariasimple_eip_deterministic>>(ptr, r_pars, r_index_group);
}
...
SEXP dust2_filter_malariasimple_eip_deterministic_run(cpp11::sexp ptr, cpp11::sexp r_initial, bool save_trajectories, cpp11::sexp save_snapshots, bool adjoint, cpp11::sexp index_state, cpp11::sexp index_group, bool preserve_particle_dimension, bool preserve_group_dimension) {
  return dust2::r::dust2_filter_run<dust2::dust_discrete<malariasimple_eip_deterministic>>(ptr, r_initial, save_trajectories, save_snapshots, adjoint, index_state, index_group, preserve_particle_dimension, preserve_group_dimension);
}
...
SEXP dust2_filter_malariasimple_eip_deterministic_last_trajectories(cpp11::sexp ptr, bool select_random_particle, bool preserve_particle_dimension, bool preserve_group_dimension) {
  return dust2::r::dust2_filter_last_trajectories<dust2::dust_discrete<malariasimple_eip_deterministic>>(ptr, select_random_particle, preserve_particle_dimension, preserve_group_dimension);
}
...
SEXP dust2_filter_malariasimple_eip_deterministic_last_snapshots(cpp11::sexp ptr, bool select_random_particle, bool preserve_particle_dimension, bool preserve_group_dimension) {
  return dust2::r::dust2_filter_last_snapshots<dust2::dust_discrete<malariasimple_eip_deterministic>>(ptr, select_random_particle, preserve_particle_dimension, preserve_group_dimension);
}
...
SEXP dust2_filter_malariasimple_eip_deterministic_last_state(cpp11::sexp ptr, bool select_random_particle, bool preserve_particle_dimension, bool preserve_group_dimension) {
  return dust2::r::dust2_filter_last_state<dust2::dust_discrete<malariasimple_eip_deterministic>>(ptr, select_random_particle, preserve_particle_dimension, preserve_group_dimension);
}

[[cpp11::register]]
SEXP dust2_filter_malariasimple_eip_deterministic_rng_state(cpp11::sexp ptr) {
  return dust2::r::dust2_filter_rng_state<dust2::dust_discrete<malariasimple_eip_deterministic>>(ptr);
}

[[cpp11::register]]
SEXP dust2_filter_malariasimple_eip_deterministic_set_rng_state(cpp11::sexp ptr, cpp11::sexp r_rng_state) {
  return dust2::r::dust2_filter_set_rng_state<dust2::dust_discrete<malariasimple_eip_deterministic>>(ptr, r_rng_state);
}
