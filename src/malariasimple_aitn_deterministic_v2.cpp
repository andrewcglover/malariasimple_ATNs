...
// [[dust2::class(malariasimple_aitn_deterministic_v2)]]
...
class malariasimple_aitn_deterministic_v2 {
public:
  malariasimple_aitn_deterministic_v2() = delete;
  ...
  static shared_state build_shared(cpp11::list parameters) {
    ...
    for (size_t i = 1; i <= dim.B_post.size; ++i) {
      B_post[i - 1] = B_max_post * (monty::math::pow(s_half_post, nH_post) / (monty::math::pow(s_half_post, nH_post) + monty::math::pow(t_post[i - 1], nH_post)));
    }
  ...
  static internal_state build_internal(const shared_state& shared) {
    ...
    return internal_state{S_death, TP_trans, T_death, DA_trans, D_death, AU_trans, A_death, US_trans, U_death, PS_trans, P_death, FOI, init_ICM_pre, IC, b, Ecol, all, births, S_age, T_age, D_age, A_age, U_age, P_age, phi, rho_i, n_prev, detect_prev, icm_pop, ica_pop, id_pop, ib_pop, ic_pop, all_deaths, p_det, B_post_Ecol, alpha_smc_array, DS_trans, AS_trans, US_trans_SMC, Lambda_i, cA, FOI_smc, smc_rel_c_mask, w_, z_, ST_rate, SD_rate, SA_rate, AT_rate, AD_rate, UA_rate, UD_rate, UT_rate, w, z, ST_trans, SD_trans, SA_trans, AT_trans, AD_trans, UA_trans, UD_trans, UT_trans, zhi, whi, dSv, dEv, dIv, av_mosq, EIR, FOIvijk, FOI_lag, epsilon_0};
  }
  ...
  static void update_shared(cpp11::list parameters, shared_state& shared) {
    ...
    for (size_t i = 1; i <= shared.dim.B_post.size; ++i) {
      shared.B_post[i - 1] = shared.B_max_post * (monty::math::pow(shared.s_half_post, shared.nH_post) / (monty::math::pow(shared.s_half_post, shared.nH_post) + monty::math::pow(shared.t_post[i - 1], shared.nH_post)));
    }
  ...
  static void update(real_type time, real_type dt, const real_type* state, const shared_state& shared, internal_state& internal, rng_state_type& rng_state, real_type* state_next) {
    ...
    for (size_t i = 1; i <= shared.dim.rho_i.size; ++i) {
      internal.rho_i[i - 1] = shared.rho - (shared.rho - rho0_t) * (monty::math::pow(shared.s_half_eip, shared.nH_eip) / (monty::math::pow(shared.s_half_eip, shared.nH_eip) + monty::math::pow((i - static_cast<real_type>(0.5)), shared.nH_eip)));
    }
    ...
    for (size_t i = 1; i <= shared.dim.Lambda_i.size; ++i) {
      internal.Lambda_i[i - 1] = Lambda - (Lambda - Lambda0_t) * (monty::math::pow(shared.s_half_pre, shared.nH_pre) / (monty::math::pow(shared.s_half_pre, shared.nH_pre) + monty::math::pow((i - static_cast<real_type>(0.5)), shared.nH_pre)));
    }
...
SEXP dust2_system_malariasimple_aitn_deterministic_v2_alloc(cpp11::list r_pars, cpp11::sexp r_time, cpp11::list r_time_control, cpp11::sexp r_n_particles, cpp11::sexp r_n_groups, cpp11::sexp r_seed, cpp11::sexp r_deterministic, cpp11::sexp r_n_threads) {
  return dust2::r::dust2_discrete_alloc<malariasimple_aitn_deterministic_v2>(r_pars, r_time, r_time_control, r_n_particles, r_n_groups, r_seed, r_deterministic, r_n_threads);
}
[[cpp11::register]]
SEXP dust2_system_malariasimple_aitn_deterministic_v2_run_to_time(cpp11::sexp ptr, cpp11::sexp r_time) {
  return dust2::r::dust2_system_run_to_time<dust2::dust_discrete<malariasimple_aitn_deterministic_v2>>(ptr, r_time);
}
...
SEXP dust2_system_malariasimple_aitn_deterministic_v2_state(cpp11::sexp ptr, cpp11::sexp r_index_state, cpp11::sexp r_index_particle, cpp11::sexp r_index_group, bool preserve_particle_dimension, bool preserve_group_dimension) {
  return dust2::r::dust2_system_state<dust2::dust_discrete<malariasimple_aitn_deterministic_v2>>(ptr, r_index_state, r_index_particle, r_index_group, preserve_particle_dimension, preserve_group_dimension);
}

[[cpp11::register]]
SEXP dust2_system_malariasimple_aitn_deterministic_v2_time(cpp11::sexp ptr) {
  return dust2::r::dust2_system_time<dust2::dust_discrete<malariasimple_aitn_deterministic_v2>>(ptr);
}

[[cpp11::register]]
SEXP dust2_system_malariasimple_aitn_deterministic_v2_set_state_initial(cpp11::sexp ptr) {
  return dust2::r::dust2_system_set_state_initial<dust2::dust_discrete<malariasimple_aitn_deterministic_v2>>(ptr);
}

[[cpp11::register]]
SEXP dust2_system_malariasimple_aitn_deterministic_v2_set_state(cpp11::sexp ptr, cpp11::list r_state) {
  return dust2::r::dust2_system_set_state<dust2::dust_discrete<malariasimple_aitn_deterministic_v2>>(ptr, r_state);
}

[[cpp11::register]]
SEXP dust2_system_malariasimple_aitn_deterministic_v2_reorder(cpp11::sexp ptr, cpp11::integers r_index) {
  return dust2::r::dust2_system_reorder<dust2::dust_discrete<malariasimple_aitn_deterministic_v2>>(ptr, r_index);
}

[[cpp11::register]]
SEXP dust2_system_malariasimple_aitn_deterministic_v2_rng_state(cpp11::sexp ptr) {
  return dust2::r::dust2_system_rng_state<dust2::dust_discrete<malariasimple_aitn_deterministic_v2>>(ptr);
}

[[cpp11::register]]
SEXP dust2_system_malariasimple_aitn_deterministic_v2_set_rng_state(cpp11::sexp ptr, cpp11::sexp r_rng_state) {
  return dust2::r::dust2_system_set_rng_state<dust2::dust_discrete<malariasimple_aitn_deterministic_v2>>(ptr, r_rng_state);
}

[[cpp11::register]]
SEXP dust2_system_malariasimple_aitn_deterministic_v2_set_time(cpp11::sexp ptr, cpp11::sexp r_time) {
  return dust2::r::dust2_system_set_time<dust2::dust_discrete<malariasimple_aitn_deterministic_v2>>(ptr, r_time);
}

[[cpp11::register]]
SEXP dust2_system_malariasimple_aitn_deterministic_v2_update_pars(cpp11::sexp ptr, cpp11::list pars) {
  return dust2::r::dust2_system_update_pars<dust2::dust_discrete<malariasimple_aitn_deterministic_v2>>(ptr, pars);
}
...
SEXP dust2_system_malariasimple_aitn_deterministic_v2_simulate(cpp11::sexp ptr, cpp11::sexp r_times, cpp11::sexp r_index_state, bool preserve_particle_dimension, bool preserve_group_dimension) {
  return dust2::r::dust2_system_simulate<dust2::dust_discrete<malariasimple_aitn_deterministic_v2>>(ptr, r_times, r_index_state, preserve_particle_dimension, preserve_group_dimension);
}
...
SEXP dust2_unfilter_malariasimple_aitn_deterministic_v2_alloc(cpp11::list r_pars, cpp11::sexp r_time_start, cpp11::sexp r_time, cpp11::list r_time_control, cpp11::list r_data, cpp11::sexp r_n_particles, cpp11::sexp r_n_groups, cpp11::sexp r_n_threads) {
  return dust2::r::dust2_discrete_unfilter_alloc<malariasimple_aitn_deterministic_v2>(r_pars, r_time_start, r_time, r_time_control, r_data, r_n_particles, r_n_groups, r_n_threads);
}
...
SEXP dust2_filter_malariasimple_aitn_deterministic_v2_alloc(cpp11::list r_pars, cpp11::sexp r_time_start, cpp11::sexp r_time, cpp11::list r_time_control, cpp11::list r_data, cpp11::sexp r_n_particles, cpp11::sexp r_n_groups, cpp11::sexp r_n_threads, cpp11::sexp r_seed) {
  return dust2::r::dust2_discrete_filter_alloc<malariasimple_aitn_deterministic_v2>(r_pars, r_time_start, r_time, r_time_control, r_data, r_n_particles, r_n_groups, r_n_threads, r_seed);
}
[[cpp11::register]]
SEXP dust2_system_malariasimple_aitn_deterministic_v2_compare_data(cpp11::sexp ptr, cpp11::list r_data, bool preserve_particle_dimension, bool preserve_group_dimension) {
  return dust2::r::dust2_system_compare_data<dust2::dust_discrete<malariasimple_aitn_deterministic_v2>>(ptr, r_data, preserve_particle_dimension, preserve_group_dimension);
}
...
SEXP dust2_unfilter_malariasimple_aitn_deterministic_v2_update_pars(cpp11::sexp ptr, cpp11::list r_pars, cpp11::sexp r_index_group) {
  return dust2::r::dust2_unfilter_update_pars<dust2::dust_discrete<malariasimple_aitn_deterministic_v2>>(ptr, r_pars, r_index_group);
}
...
SEXP dust2_unfilter_malariasimple_aitn_deterministic_v2_run(cpp11::sexp ptr, cpp11::sexp r_initial, bool save_trajectories, cpp11::sexp save_snapshots, bool adjoint, cpp11::sexp r_index_state, cpp11::sexp r_index_group, bool preserve_particle_dimension, bool preserve_group_dimension) {
  return dust2::r::dust2_unfilter_run<dust2::dust_discrete<malariasimple_aitn_deterministic_v2>>(ptr, r_initial, save_trajectories, save_snapshots, adjoint, r_index_state, r_index_group, preserve_particle_dimension, preserve_group_dimension);
}
...
SEXP dust2_unfilter_malariasimple_aitn_deterministic_v2_last_trajectories(cpp11::sexp ptr, bool select_random_particle, bool preserve_particle_dimension, bool preserve_group_dimension) {
  return dust2::r::dust2_unfilter_last_trajectories<dust2::dust_discrete<malariasimple_aitn_deterministic_v2>>(ptr, select_random_particle, preserve_particle_dimension, preserve_group_dimension);
}
...
SEXP dust2_unfilter_malariasimple_aitn_deterministic_v2_last_snapshots(cpp11::sexp ptr, bool select_random_particle, bool preserve_particle_dimension, bool preserve_group_dimension) {
  return dust2::r::dust2_unfilter_last_snapshots<dust2::dust_discrete<malariasimple_aitn_deterministic_v2>>(ptr, select_random_particle, preserve_particle_dimension, preserve_group_dimension);
}
...
SEXP dust2_unfilter_malariasimple_aitn_deterministic_v2_last_state(cpp11::sexp ptr, bool select_random_particle, bool preserve_particle_dimension, bool preserve_group_dimension) {
  return dust2::r::dust2_unfilter_last_state<dust2::dust_discrete<malariasimple_aitn_deterministic_v2>>(ptr, select_random_particle, preserve_particle_dimension, preserve_group_dimension);
}
...
SEXP dust2_filter_malariasimple_aitn_deterministic_v2_update_pars(cpp11::sexp ptr, cpp11::list r_pars, cpp11::sexp r_index_group) {
  return dust2::r::dust2_filter_update_pars<dust2::dust_discrete<malariasimple_aitn_deterministic_v2>>(ptr, r_pars, r_index_group);
}
...
SEXP dust2_filter_malariasimple_aitn_deterministic_v2_run(cpp11::sexp ptr, cpp11::sexp r_initial, bool save_trajectories, cpp11::sexp save_snapshots, bool adjoint, cpp11::sexp index_state, cpp11::sexp index_group, bool preserve_particle_dimension, bool preserve_group_dimension) {
  return dust2::r::dust2_filter_run<dust2::dust_discrete<malariasimple_aitn_deterministic_v2>>(ptr, r_initial, save_trajectories, save_snapshots, adjoint, index_state, index_group, preserve_particle_dimension, preserve_group_dimension);
}
...
SEXP dust2_filter_malariasimple_aitn_deterministic_v2_last_trajectories(cpp11::sexp ptr, bool select_random_particle, bool preserve_particle_dimension, bool preserve_group_dimension) {
  return dust2::r::dust2_filter_last_trajectories<dust2::dust_discrete<malariasimple_aitn_deterministic_v2>>(ptr, select_random_particle, preserve_particle_dimension, preserve_group_dimension);
}
...
SEXP dust2_filter_malariasimple_aitn_deterministic_v2_last_snapshots(cpp11::sexp ptr, bool select_random_particle, bool preserve_particle_dimension, bool preserve_group_dimension) {
  return dust2::r::dust2_filter_last_snapshots<dust2::dust_discrete<malariasimple_aitn_deterministic_v2>>(ptr, select_random_particle, preserve_particle_dimension, preserve_group_dimension);
}
...
SEXP dust2_filter_malariasimple_aitn_deterministic_v2_last_state(cpp11::sexp ptr, bool select_random_particle, bool preserve_particle_dimension, bool preserve_group_dimension) {
  return dust2::r::dust2_filter_last_state<dust2::dust_discrete<malariasimple_aitn_deterministic_v2>>(ptr, select_random_particle, preserve_particle_dimension, preserve_group_dimension);
}

[[cpp11::register]]
SEXP dust2_filter_malariasimple_aitn_deterministic_v2_rng_state(cpp11::sexp ptr) {
  return dust2::r::dust2_filter_rng_state<dust2::dust_discrete<malariasimple_aitn_deterministic_v2>>(ptr);
}

[[cpp11::register]]
SEXP dust2_filter_malariasimple_aitn_deterministic_v2_set_rng_state(cpp11::sexp ptr, cpp11::sexp r_rng_state) {
  return dust2::r::dust2_filter_set_rng_state<dust2::dust_discrete<malariasimple_aitn_deterministic_v2>>(ptr, r_rng_state);
}
