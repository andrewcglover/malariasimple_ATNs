...
// [[dust2::class(malariasimple_aitn_deterministic_v2pt1)]]
...
// [[dust2::parameter(t0_atn, type = "real_type", rank = 0, required = TRUE, constant = FALSE)]]
// [[dust2::parameter(Q0_atn, type = "real_type", rank = 0, required = TRUE, constant = FALSE)]]
...
class malariasimple_aitn_deterministic_v2pt1 {
public:
  malariasimple_aitn_deterministic_v2pt1() = delete;
  ...
  static shared_state build_shared(cpp11::list parameters) {
    ...
    const real_type t0_atn = dust2::r::read_real(parameters, "t0_atn");
    const real_type Q0_atn = dust2::r::read_real(parameters, "Q0_atn");
  ...
  static internal_state build_internal(const shared_state& shared) {
    ...
    return internal_state{S_death, TP_trans, T_death, DA_trans, D_death, AU_trans, A_death, US_trans, U_death, PS_trans, P_death, FOI, init_ICM_pre, IC, b, Ecol, all, births, S_age, T_age, D_age, A_age, U_age, P_age, phi, n_prev, detect_prev, icm_pop, ica_pop, id_pop, ib_pop, ic_pop, all_deaths, p_det, rho_i, alpha_smc_array, DS_trans, AS_trans, US_trans_SMC, b_lab_pre, B_post_Ecol, cA, FOI_smc, smc_rel_c_mask, w_, z_, ST_rate, SD_rate, SA_rate, AT_rate, AD_rate, UA_rate, UD_rate, UT_rate, b_field_pre, w, z, ST_trans, SD_trans, SA_trans, AT_trans, AD_trans, UA_trans, UD_trans, UT_trans, Lambda_i, zhi, whi, dSv, dEv, dIv, av_mosq, EIR, FOIvijk, FOI_lag, epsilon_0};
  }
  ...
  static void update_shared(cpp11::list parameters, shared_state& shared) {
    ...
    shared.t0_atn = dust2::r::read_real(parameters, "t0_atn", shared.t0_atn);
    shared.Q0_atn = dust2::r::read_real(parameters, "Q0_atn", shared.Q0_atn);
  ...
  static void update(real_type time, real_type dt, const real_type* state, const shared_state& shared, internal_state& internal, rng_state_type& rng_state, real_type* state_next) {
    ...
    const real_type dn_atn = (time < shared.t0_atn ? 0 : shared.dn0_atn * monty::math::exp(-shared.gamma_atn * (time - shared.t0_atn)));
    ...
    const real_type Q_atn_t = (time < shared.t0_atn ? 0 : shared.Q0_atn * monty::math::exp(-shared.lambda_atn * (time - shared.t0_atn)));
...
SEXP dust2_system_malariasimple_aitn_deterministic_v2pt1_alloc(cpp11::list r_pars, cpp11::sexp r_time, cpp11::list r_time_control, cpp11::sexp r_n_particles, cpp11::sexp r_n_groups, cpp11::sexp r_seed, cpp11::sexp r_deterministic, cpp11::sexp r_n_threads) {
  return dust2::r::dust2_discrete_alloc<malariasimple_aitn_deterministic_v2pt1>(r_pars, r_time, r_time_control, r_n_particles, r_n_groups, r_seed, r_deterministic, r_n_threads);
}
[[cpp11::register]]
SEXP dust2_system_malariasimple_aitn_deterministic_v2pt1_run_to_time(cpp11::sexp ptr, cpp11::sexp r_time) {
  return dust2::r::dust2_system_run_to_time<dust2::dust_discrete<malariasimple_aitn_deterministic_v2pt1>>(ptr, r_time);
}
...
SEXP dust2_system_malariasimple_aitn_deterministic_v2pt1_state(cpp11::sexp ptr, cpp11::sexp r_index_state, cpp11::sexp r_index_particle, cpp11::sexp r_index_group, bool preserve_particle_dimension, bool preserve_group_dimension) {
  return dust2::r::dust2_system_state<dust2::dust_discrete<malariasimple_aitn_deterministic_v2pt1>>(ptr, r_index_state, r_index_particle, r_index_group, preserve_particle_dimension, preserve_group_dimension);
}

[[cpp11::register]]
SEXP dust2_system_malariasimple_aitn_deterministic_v2pt1_time(cpp11::sexp ptr) {
  return dust2::r::dust2_system_time<dust2::dust_discrete<malariasimple_aitn_deterministic_v2pt1>>(ptr);
}

[[cpp11::register]]
SEXP dust2_system_malariasimple_aitn_deterministic_v2pt1_set_state_initial(cpp11::sexp ptr) {
  return dust2::r::dust2_system_set_state_initial<dust2::dust_discrete<malariasimple_aitn_deterministic_v2pt1>>(ptr);
}

[[cpp11::register]]
SEXP dust2_system_malariasimple_aitn_deterministic_v2pt1_set_state(cpp11::sexp ptr, cpp11::list r_state) {
  return dust2::r::dust2_system_set_state<dust2::dust_discrete<malariasimple_aitn_deterministic_v2pt1>>(ptr, r_state);
}

[[cpp11::register]]
SEXP dust2_system_malariasimple_aitn_deterministic_v2pt1_reorder(cpp11::sexp ptr, cpp11::integers r_index) {
  return dust2::r::dust2_system_reorder<dust2::dust_discrete<malariasimple_aitn_deterministic_v2pt1>>(ptr, r_index);
}

[[cpp11::register]]
SEXP dust2_system_malariasimple_aitn_deterministic_v2pt1_rng_state(cpp11::sexp ptr) {
  return dust2::r::dust2_system_rng_state<dust2::dust_discrete<malariasimple_aitn_deterministic_v2pt1>>(ptr);
}

[[cpp11::register]]
SEXP dust2_system_malariasimple_aitn_deterministic_v2pt1_set_rng_state(cpp11::sexp ptr, cpp11::sexp r_rng_state) {
  return dust2::r::dust2_system_set_rng_state<dust2::dust_discrete<malariasimple_aitn_deterministic_v2pt1>>(ptr, r_rng_state);
}

[[cpp11::register]]
SEXP dust2_system_malariasimple_aitn_deterministic_v2pt1_set_time(cpp11::sexp ptr, cpp11::sexp r_time) {
  return dust2::r::dust2_system_set_time<dust2::dust_discrete<malariasimple_aitn_deterministic_v2pt1>>(ptr, r_time);
}

[[cpp11::register]]
SEXP dust2_system_malariasimple_aitn_deterministic_v2pt1_update_pars(cpp11::sexp ptr, cpp11::list pars) {
  return dust2::r::dust2_system_update_pars<dust2::dust_discrete<malariasimple_aitn_deterministic_v2pt1>>(ptr, pars);
}
...
SEXP dust2_system_malariasimple_aitn_deterministic_v2pt1_simulate(cpp11::sexp ptr, cpp11::sexp r_times, cpp11::sexp r_index_state, bool preserve_particle_dimension, bool preserve_group_dimension) {
  return dust2::r::dust2_system_simulate<dust2::dust_discrete<malariasimple_aitn_deterministic_v2pt1>>(ptr, r_times, r_index_state, preserve_particle_dimension, preserve_group_dimension);
}
...
SEXP dust2_unfilter_malariasimple_aitn_deterministic_v2pt1_alloc(cpp11::list r_pars, cpp11::sexp r_time_start, cpp11::sexp r_time, cpp11::list r_time_control, cpp11::list r_data, cpp11::sexp r_n_particles, cpp11::sexp r_n_groups, cpp11::sexp r_n_threads) {
  return dust2::r::dust2_discrete_unfilter_alloc<malariasimple_aitn_deterministic_v2pt1>(r_pars, r_time_start, r_time, r_time_control, r_data, r_n_particles, r_n_groups, r_n_threads);
}
...
SEXP dust2_filter_malariasimple_aitn_deterministic_v2pt1_alloc(cpp11::list r_pars, cpp11::sexp r_time_start, cpp11::sexp r_time, cpp11::list r_time_control, cpp11::list r_data, cpp11::sexp r_n_particles, cpp11::sexp r_n_groups, cpp11::sexp r_n_threads, cpp11::sexp r_seed) {
  return dust2::r::dust2_discrete_filter_alloc<malariasimple_aitn_deterministic_v2pt1>(r_pars, r_time_start, r_time, r_time_control, r_data, r_n_particles, r_n_groups, r_n_threads, r_seed);
}
[[cpp11::register]]
SEXP dust2_system_malariasimple_aitn_deterministic_v2pt1_compare_data(cpp11::sexp ptr, cpp11::list r_data, bool preserve_particle_dimension, bool preserve_group_dimension) {
  return dust2::r::dust2_system_compare_data<dust2::dust_discrete<malariasimple_aitn_deterministic_v2pt1>>(ptr, r_data, preserve_particle_dimension, preserve_group_dimension);
}
...
SEXP dust2_unfilter_malariasimple_aitn_deterministic_v2pt1_update_pars(cpp11::sexp ptr, cpp11::list r_pars, cpp11::sexp r_index_group) {
  return dust2::r::dust2_unfilter_update_pars<dust2::dust_discrete<malariasimple_aitn_deterministic_v2pt1>>(ptr, r_pars, r_index_group);
}
...
SEXP dust2_unfilter_malariasimple_aitn_deterministic_v2pt1_run(cpp11::sexp ptr, cpp11::sexp r_initial, bool save_trajectories, cpp11::sexp save_snapshots, bool adjoint, cpp11::sexp r_index_state, cpp11::sexp r_index_group, bool preserve_particle_dimension, bool preserve_group_dimension) {
  return dust2::r::dust2_unfilter_run<dust2::dust_discrete<malariasimple_aitn_deterministic_v2pt1>>(ptr, r_initial, save_trajectories, save_snapshots, adjoint, r_index_state, r_index_group, preserve_particle_dimension, preserve_group_dimension);
}
...
SEXP dust2_unfilter_malariasimple_aitn_deterministic_v2pt1_last_trajectories(cpp11::sexp ptr, bool select_random_particle, bool preserve_particle_dimension, bool preserve_group_dimension) {
  return dust2::r::dust2_unfilter_last_trajectories<dust2::dust_discrete<malariasimple_aitn_deterministic_v2pt1>>(ptr, select_random_particle, preserve_particle_dimension, preserve_group_dimension);
}
...
SEXP dust2_unfilter_malariasimple_aitn_deterministic_v2pt1_last_snapshots(cpp11::sexp ptr, bool select_random_particle, bool preserve_particle_dimension, bool preserve_group_dimension) {
  return dust2::r::dust2_unfilter_last_snapshots<dust2::dust_discrete<malariasimple_aitn_deterministic_v2pt1>>(ptr, select_random_particle, preserve_particle_dimension, preserve_group_dimension);
}
...
SEXP dust2_unfilter_malariasimple_aitn_deterministic_v2pt1_last_state(cpp11::sexp ptr, bool select_random_particle, bool preserve_particle_dimension, bool preserve_group_dimension) {
  return dust2::r::dust2_unfilter_last_state<dust2::dust_discrete<malariasimple_aitn_deterministic_v2pt1>>(ptr, select_random_particle, preserve_particle_dimension, preserve_group_dimension);
}
...
SEXP dust2_filter_malariasimple_aitn_deterministic_v2pt1_update_pars(cpp11::sexp ptr, cpp11::list r_pars, cpp11::sexp r_index_group) {
  return dust2::r::dust2_filter_update_pars<dust2::dust_discrete<malariasimple_aitn_deterministic_v2pt1>>(ptr, r_pars, r_index_group);
}
...
SEXP dust2_filter_malariasimple_aitn_deterministic_v2pt1_run(cpp11::sexp ptr, cpp11::sexp r_initial, bool save_trajectories, cpp11::sexp save_snapshots, bool adjoint, cpp11::sexp index_state, cpp11::sexp index_group, bool preserve_particle_dimension, bool preserve_group_dimension) {
  return dust2::r::dust2_filter_run<dust2::dust_discrete<malariasimple_aitn_deterministic_v2pt1>>(ptr, r_initial, save_trajectories, save_snapshots, adjoint, index_state, index_group, preserve_particle_dimension, preserve_group_dimension);
}
...
SEXP dust2_filter_malariasimple_aitn_deterministic_v2pt1_last_trajectories(cpp11::sexp ptr, bool select_random_particle, bool preserve_particle_dimension, bool preserve_group_dimension) {
  return dust2::r::dust2_filter_last_trajectories<dust2::dust_discrete<malariasimple_aitn_deterministic_v2pt1>>(ptr, select_random_particle, preserve_particle_dimension, preserve_group_dimension);
}
...
SEXP dust2_filter_malariasimple_aitn_deterministic_v2pt1_last_snapshots(cpp11::sexp ptr, bool select_random_particle, bool preserve_particle_dimension, bool preserve_group_dimension) {
  return dust2::r::dust2_filter_last_snapshots<dust2::dust_discrete<malariasimple_aitn_deterministic_v2pt1>>(ptr, select_random_particle, preserve_particle_dimension, preserve_group_dimension);
}
...
SEXP dust2_filter_malariasimple_aitn_deterministic_v2pt1_last_state(cpp11::sexp ptr, bool select_random_particle, bool preserve_particle_dimension, bool preserve_group_dimension) {
  return dust2::r::dust2_filter_last_state<dust2::dust_discrete<malariasimple_aitn_deterministic_v2pt1>>(ptr, select_random_particle, preserve_particle_dimension, preserve_group_dimension);
}

[[cpp11::register]]
SEXP dust2_filter_malariasimple_aitn_deterministic_v2pt1_rng_state(cpp11::sexp ptr) {
  return dust2::r::dust2_filter_rng_state<dust2::dust_discrete<malariasimple_aitn_deterministic_v2pt1>>(ptr);
}

[[cpp11::register]]
SEXP dust2_filter_malariasimple_aitn_deterministic_v2pt1_set_rng_state(cpp11::sexp ptr, cpp11::sexp r_rng_state) {
  return dust2::r::dust2_filter_set_rng_state<dust2::dust_discrete<malariasimple_aitn_deterministic_v2pt1>>(ptr, r_rng_state);
}
